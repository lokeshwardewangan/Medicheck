...
import { Edit, CheckCircle, AlertCircle, Lock } from 'lucide-react';
...
export function SummaryShell({ profileComplete }: Props) {
  ...
  const handleEdit = (section: 'chat' | 'assessment') => {
    router.push(section === 'chat' ? '/chat' : '/assessment');
  };
      ...
      <div className="container mx-auto max-w-2xl px-4 py-8">
        ...
        <div className="flex flex-col gap-4 sm:flex-row">
          ...
          <Button
            ...
            title={profileComplete ? undefined : 'Complete the profile above to continue'}
          >
            {profileComplete ? (
